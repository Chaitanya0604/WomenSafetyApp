...
import com.example.womensafetyapp.Contacts.ContactModel;
import com.example.womensafetyapp.Contacts.CustomAdapter;
import com.example.womensafetyapp.Contacts.DbHelper;
import com.example.womensafetyapp.Services.ReactivateService;
import com.example.womensafetyapp.Services.SensorService;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        ContactModel call =list.get(0);
        Intent i = new Intent(Intent.ACTION_CALL);
        i.setData(Uri.parse("tel:" + call.getPhoneNo()));
        startActivity(i);
    }
}
